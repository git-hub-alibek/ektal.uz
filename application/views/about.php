                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="section-title text-center">
                                ...
                                <h2><strong><?php echo lang('menu_about');?></strong></h2>
                            </div>
                        </div>
                    </div>
                    <div class="row pt-3">
                            ...
                            <div class="service-box service-style-1">
                                ...
                                <div class="service-content">
                                    <div class="service-inner">
                                        <h3 class="service-box-title"><a href=""><?php echo lang('title1');?></a></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="service-box service-style-1">
                                ...
                                <div class="service-content">
                                    <div class="service-inner">
                                        <h3 class="service-box-title"><a href="service-detail.html"><?php echo lang('title2');?></a></h3>
                                        <div class="service-desc">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="service-box service-style-1">
                                ...
                                <div class="service-content">
                                    <div class="service-inner">
                                        <h3 class="service-box-title"><a href="service-detail.html"><?php echo lang('title3');?></a></h3>
                                        <div class="service-desc">
